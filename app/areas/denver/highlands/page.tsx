...
export const metadata: Metadata = {
  title: "Roof Repair Highlands Denver | Victorian & Bungalow Specialists",
  description: "Expert roof repair in the Highlands, Denver. Victorian, bungalow, and renovated homes. Hail damage, steep pitches, full replacements. Free inspections.",
  keywords: "roof repair highlands denver, highlands denver roofing, victorian roof repair denver, bungalow roof denver",
  alternates: { canonical: "https://roofrepairindenver.com/areas/denver/highlands" },
};
...
const localSchema = {
  ...
  "areaServed": { "@type": "Place", "name": "Highlands" },
      ...
      <main>
        <section className="relative py-20 px-6" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200&q=80')", backgroundSize: "cover", backgroundPosition: "center" }}>
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="text-[10px] font-black uppercase tracking-[0.3em] text-[#e94560] mb-4">
              <Link href="/" className="hover:text-[#ff5a77]">Home</Link> / <Link href="/areas-we-serve" className="hover:text-[#ff5a77]">Areas</Link> / Highlands
            </div>
            <h1 className="font-display text-5xl md:text-6xl leading-tight tracking-tighter uppercase mb-6 text-[#e2e2e2]">
              Roof Repair<br /><span className="text-[#e94560]">Highlands, Denver</span>
            </h1>
            <p className="text-xl text-[#c8c5cd] max-w-2xl mb-8 leading-relaxed">
              Serving the Highlands with expert roof repair for Victorians, bungalows, and renovated homes.
            </p>
        ...
        <section className="py-20 px-6">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16">
            <div>
              <h2 className="section-heading mb-6">About Highlands</h2>
              <div className="space-y-4 text-[#c8c5cd] leading-relaxed">
                <p><strong className="text-[#e2e2e2]">Housing Era:</strong> 1880s–1940s Victorian and bungalow</p>
                <p><strong className="text-[#e2e2e2]">Common Roofing Material:</strong> Asphalt shingles, some original wood shake, metal on renovated homes</p>
                <p><strong className="text-[#e2e2e2]">Average Home Value:</strong> $650K–$900K</p>
              </div>
            </div>
            <div>
              <h2 className="section-heading mb-6">Roofing Challenges in Highlands</h2>
              <p className="text-[#c8c5cd] leading-relaxed">
                Older housing stock frequently has multiple roof layers. Victorian homes have steep pitches that increase labor costs and complexity. Gentrification is driving high-end material upgrades — metal roofs and premium architectural shingles are increasingly common. Many homes have balloon framing requiring careful ventilation planning.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-6" style={{ backgroundColor: "#1a1a2e" }}>
          <div className="max-w-5xl mx-auto">
            <h2 className="section-heading mb-10">Services in Highlands</h2>
        ...
        <section className="py-16 px-6" style={{ backgroundColor: "#1a1a2e" }}>
          <div className="max-w-3xl mx-auto">
            <h2 className="font-display text-3xl text-center mb-3 text-[#e2e2e2] uppercase">Get Same-Day Service in Highlands</h2>
