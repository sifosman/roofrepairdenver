      ...
      <main>
        <section className="relative py-20 px-6" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200&q=80')", backgroundSize: "cover", backgroundPosition: "center" }}>
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="text-[10px] font-black uppercase tracking-[0.3em] text-[#e94560] mb-4">
              <Link href="/" className="hover:text-[#ff5a77]">Home</Link> / <Link href="/areas-we-serve" className="hover:text-[#ff5a77]">Areas</Link> / Southshore
            </div>
            <h1 className="font-display text-5xl md:text-6xl leading-tight tracking-tighter uppercase mb-6 text-[#e2e2e2]">
              Roof Repair<br /><span className="text-[#e94560]">Southshore, Aurora</span>
            </h1>
            <p className="text-xl text-[#c8c5cd] max-w-2xl mb-8 leading-relaxed">
              Serving Southshore with HOA-compliant roof repair and hail damage restoration.
            </p>
        ...
        <section className="py-20 px-6">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16">
            <div>
              <h2 className="section-heading mb-6">About Southshore</h2>
              <div className="space-y-4 text-[#c8c5cd] leading-relaxed">
                <p><strong className="text-[#e2e2e2]">Housing Era:</strong> 1990s–2010s suburban development</p>
                <p><strong className="text-[#e2e2e2]">Common Roofing Material:</strong> Architectural shingles, some concrete tile</p>
                <p><strong className="text-[#e2e2e2]">Average Home Value:</strong> $500K–$750K</p>
              </div>
            </div>
            <div>
              <h2 className="section-heading mb-6">Roofing Challenges in Southshore</h2>
              <p className="text-[#c8c5cd] leading-relaxed">
                Master-planned community with strict architectural controls. Pre-approval required for roof replacements. Approved shingle color palettes posted in community guidelines. Class 4 shingles encouraged. Many homes from the 1990s–2000s have original roofs now aging. Hail corridor location means high claim frequency.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-6" style={{ backgroundColor: "#1a1a2e" }}>
          <div className="max-w-5xl mx-auto">
            <h2 className="section-heading mb-10">Services in Southshore</h2>
        ...
        <section className="py-16 px-6" style={{ backgroundColor: "#1a1a2e" }}>
          <div className="max-w-3xl mx-auto">
            <h2 className="font-display text-3xl text-center mb-3 text-[#e2e2e2] uppercase">Get Same-Day Service in Southshore</h2>
